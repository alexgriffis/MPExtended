    ...
    internal class MonolithicPowerscheduler : IDevTool
    {
        ...
        public void Run()
        {
            ...
            string arguments = String.Format(
                @"/target:library /v4 ""/out:{0}/MPExtended.PowerScheduler.dll"" ""{0}/MPExtended.Applications.PowerSchedulerPlugin.dll"" ""{0}/MPExtended.Services.MetaService.Interfaces.dll"" ""{0}/MPExtended.Services.Common.Interfaces.dll""",
